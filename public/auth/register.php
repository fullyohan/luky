    ...
    <div class="container flex-grow-1 d-flex align-items-center justify-content-center py-5 px-4">
        <div class="card shadow-sm border-0 p-4 w-100" style="max-width: 450px; border-radius: 12px;">
            <div class="text-center mb-4">
                <h2 class="fw-bold fs-3 text-dark mb-2">Créez votre compte</h2>
                <p class="text-muted small">Rejoignez la communauté pour publier et gérer vos annonces.</p>
            </div>
            <form action="/handlers/auth-handler.php" method="POST">
                <?php 
                    ...
                    TextInput(
                        ...
                        isRequired: true, 
                        subtitle: "Votre adresse email doit être unique sur notre site."
                    ); 
                    ...
                    TextInput(
                        ...
                        placeholder: "Les deux doivent correspondre", 
                        isRequired: true
                    ); 
