...
if (isset($_GET['id'])) {
    ...
    $seller_id = (int) $post['user_id'];
    
    $sql_user = "SELECT first_name FROM users WHERE id = $seller_id";
    $result_user = mysqli_query($db, $sql_user);
    $user_data = mysqli_fetch_assoc($result_user);
    $post['seller_name'] = $user_data['first_name'] ?? 'Inconnu';
        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-lg-8">
                ...
                <div class="card border-0 p-4 shadow-sm mb-4">
                    <h1 class="fw-bold fs-4 text-dark mb-2"><?= htmlspecialchars($post['title']) ?></h1>
                    <div class="mb-3">
            ...
            <div class="col-12 col-lg-4">
                <div class="card border-0 p-4 shadow-sm" style="top: 20px;">
                    ...
                    <div class="pt-3 border-top d-flex align-items-center gap-3">
                        <div class="bg-warning text-dark rounded-circle d-flex align-items-center justify-content-center fw-bold fs-6 shadow-sm"
